...
struct osip_transaction {
  ...
  void *config; /**< (internal) transaction is managed by osip_t  */
	...
	// enum type which is consist of ICT, IST, and NICT...
 ...
 */
// The osip_message_cb_t is a type of function
 ...
 * @struct osip
 */
// call back function and chain table of transactions
struct osip {
  ...
  /* list of transactions for ict, ist, nict, nist */
	// The list table of some structure 
...
// msg_callbacks array is a function pointer array
